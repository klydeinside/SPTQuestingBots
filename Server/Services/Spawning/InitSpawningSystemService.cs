...
namespace QuestingBots.Services.Spawning
{
    ...
    public class InitSpawningSystemService : AbstractService
    {
        ...
        private GenerateBotWavePatch _generateBotWavePatch;

        public InitSpawningSystemService(LoggingUtil logger, ConfigUtil config, PmcConfig pmcConfig, BotConfig botConfig, LocationConfig locationConfig, LocationTable locationTable, GenerateBotWavePatch generateBotWavePatch) : base(logger, config)
        {
            _logger = logger;
            _config = config;
            ...
            _generateBotWavePatch = generateBotWavePatch;
        }
